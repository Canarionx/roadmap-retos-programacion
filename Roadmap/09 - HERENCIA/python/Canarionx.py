...
my_manager = Manager(1, "Canarion")
my_project_manager = ProjectManager(2, "Adan", "Proyecto 1")
my_project_manager2 = ProjectManager(3, "Aday", "Proyecto 2")
my_programmer = Programmer(4, "Feluco", "Phyton")
my_programmer2 = Programmer(5, "", "Cobol")
